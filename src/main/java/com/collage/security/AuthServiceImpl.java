...
import com.collage.repository.RoleRepository;
...
public class AuthServiceImpl implements AuthService {
    ...
    public static User getUser() {
        ...
        com.collage.security.UserPrincipal principal = (com.collage.security.UserPrincipal) auth.getPrincipal();
    ...
    private User createUser(RegisterPayload payload) {
        ...
        Role role = roleRepository.findByRoleAndActiveTrue("")
